...
function updateConfigContentBody(config_item) {
    ...
    switch(config_item.toLowerCase()) {
        ...
        case "tablist_modification":
            ...
            body += "<img src  onerror=\"setup_drag_format('#tablist-format-droppable', '#tablist-output', config_data.tablist_modification.format, '" + config_data.tablist_modification.format + "', 'tablist_modification', false);\">"; // Dirty trick
            body += "</div><br /><br /><br />";
